...
function SettingPage() {
  ...
  return (
    <div className="pt-2 overflow-auto space-y-2 relative container max-w-2xl mx-auto px-4">
      <FeatureCard title="Exports data" description="Export and store your data in a secure place.">
        <ExportButton workspaceId={workspaceId} />
      </FeatureCard>

      <Divider />

      <FeatureCard title="Import data" description="Restore your data from a backup. All your data will be replaced.">
      ...
      <FeatureCard
        ...
        containerClassName="sm:max-w-[300px] flex-col gap-2 items-end"
      >
        <Feedback />
      </FeatureCard>
